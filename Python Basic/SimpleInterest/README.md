## Python Practice Question – Simple Interest and Total Amount
...
- Calculate the **simple interest and total amount** based on principal, rate of interest, and time.
...
- Total Amount: Total = Principal + SI

### Input Handling
- Accepting integer input (`int()`) for principal amount, rate of interest, and time
