## Python Practice Question – Compound Interest and Total Amount
...
- Calculate the **compound interest and total amount** based on principal, rate of interest, and time.
...
- Total Amount: Amount = Principal * (1 + (Rate / 100)) ** Time
- Compound Interest: CI = Amount - Principal

### Input Handling
- Accepting floating-point input (`float()`) for principal amount, rate of interest, and time
- Performing calculations using user-provided values
- Rounding the final compound interest and total amount outputs to two decimal places using `round()`
...
The program prints the calculated compound interest and total amount directly to the console after taking user input.  
The complete console output for this practice question is shown below.

![Console Output](Output_5.png)

---

## 📂 File Information

- `CompoundInterest.py` — Contains the practice question program  
- `Output_5.png` — Screenshot of console output  
