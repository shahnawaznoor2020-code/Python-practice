## Python Practice Question – Area and Perimeter of a Triangle
...
- Calculate the **area and perimeter of a triangle** based on the lengths of its three sides.
...
- Perimeter: p = a+b+c
- Area of a triangle (Heron's Formula): Area = √(s(s-a)(s-b)(s-c))

### Input Handling
- Accepting floating-point input (`float()`) for the three sides of the triangle
- Performing calculations using user-provided values
- Rounding the final area output to two decimal places using `round()`
